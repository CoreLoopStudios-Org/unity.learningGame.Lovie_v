...
public class FigmaBridgeAutoSetup
{
    ...
    public static void RunSetup()
    {
        ...
        // Retrieve Personal Access Token from environment variable or saved token
        // SECURITY: No hardcoded tokens — use environment variable FIGMA_PERSONAL_ACCESS_TOKEN
